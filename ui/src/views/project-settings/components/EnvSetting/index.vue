...
async function toVarPage() {
  ...
  router.push(`/${router.currentRoute.value.params.projectId}/project-setting/enviroment/var`);
}
...
async function toParamsPage() {
  ...
  store.dispatch('ProjectSetting/setEnvDetail', null);
  router.push(`/${router.currentRoute.value.params.projectId}/project-setting/enviroment/params`);
}
...
async function toEnvDetail(env: any) {
  ...
  console.log(router.currentRoute.value.params.projectId);
  router.push(`/${router.currentRoute.value.params.projectId}/project-setting/enviroment/envdetail${env ? `/${env.id}` : ''}`);
}
