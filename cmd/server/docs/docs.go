        ...
        "/api/v1/scenarios/processors/{category}/save": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "ProcessorGroup",
                        "name": "ProcessorGroup",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorGroup"
                        }
                    },
                    {
                        "description": "ProcessorLogic",
                        "name": "ProcessorLogic",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorLogic"
                        }
                    },
                    {
                        "description": "ProcessorLoop",
                        "name": "ProcessorLoop",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorLoop"
                        }
                    },
                    {
                        "description": "ProcessorTimer",
                        "name": "ProcessorTimer",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorTimer"
                        }
                    },
                    {
                        "description": "ProcessorPrint",
                        "name": "ProcessorPrint",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorPrint"
                        }
                    },
                    {
                        "description": "ProcessorVariable",
                        "name": "ProcessorVariable",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorVariable"
                        }
                    },
                    {
                        "description": "ProcessorCookie",
                        "name": "ProcessorCookie",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorCookie"
                        }
                    },
                    {
                        "description": "ProcessorAssertion",
                        "name": "ProcessorAssertion",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorAssertion"
                        }
                    },
                    {
                        "description": "ProcessorExtractor",
                        "name": "ProcessorExtractor",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProcessorExtractor"
                        }
                    },
                    {
                        "description": "ProcessorData",
                        "name": "ProcessorData",
                        "in": "body",
                        "required": true,
                        "schema": {
