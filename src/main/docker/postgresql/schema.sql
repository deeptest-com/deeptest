	  ...
	  RAISE NOTICE 'rec_custom_field.input=%', rec_custom_field."input";
	   ...
	   if (rec_custom_field."input"='dropdown' OR rec_custom_field."input"='radio'
	       ...
	       insert into "CustomFieldOption"("label","value",ordr,"fieldId","orgId",
		     ...
		     select d.label,d.value,d.ordr,rec_custom_field.id,p_org_id,
...
CREATE TABLE public."IsuIssue" (
    ...
    "priorityId" integer,
    "priorityName" character varying(255),
    "assigneeId" integer,
    ...
    "resolutionName" character varying(1000),
...
CREATE TABLE public."TstOrgGroupUserRelation" (
    "orgId" integer,
    "orgGroupId" integer,
    "orgGroupName" character varying(255),
    "userId" integer,
...
ALTER TABLE ONLY public."IsuWorkflowTransition"
    ADD CONSTRAINT "IsuWorkflowTransition_dictStatusId_fkey" FOREIGN KEY ("dictStatusId") REFERENCES public."IsuStatus"(id);
...
ALTER TABLE ONLY public."IsuWorkflowTransition"
    ADD CONSTRAINT "IsuWorkflowTransition_srcStatusId_fkey" FOREIGN KEY ("srcStatusId") REFERENCES public."IsuStatus"(id);
...
1	阻塞	block	\N	1	f	1	f	f	2018-11-09 12:49:25	\N
2	紧急	critical	\N	2	f	1	f	f	2018-11-09 12:49:28	\N
3	重要	major	\N	3	f	1	f	f	2018-11-09 12:49:31	\N
4	一般	normal	\N	4	t	1	f	f	2018-11-09 12:49:33	\N
5	细微	minor	\N	5	f	1	f	f	2018-11-09 12:49:36	\N
\.
...
2	不是缺陷	not_defect	\N	\N	1	f	f	2018-11-23 15:26:22	\N
1	修复	fixed	t	\N	1	f	f	2018-11-23 15:25:52	\N
\.
...
1	待办	todo	\N	1	f	f	2018-11-13 09:05:24	\N
2	处理中	in_progress	\N	2	f	f	2018-11-13 09:05:45	\N
3	完成	completed	\N	3	f	f	2018-11-13 09:06:05	\N
\.
