...
func getDatapoolValue(session *ExecSession, placeholder string) (ret string) {
	...
	rowIndex := getDatapoolRow(dpName, dpSeq, execScene.Datapools, session.DatapoolCursor)
