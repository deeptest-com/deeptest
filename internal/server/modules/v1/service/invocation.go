...
func (s *InvocationService) Create(req serverDomain.TestRequest,
	resp serverDomain.TestResponse, projectId int) (request model.Invocation, err error) {
...
func (s *InvocationService) CopyValueFromRequest(interf *model.Invocation, req serverDomain.TestRequest) (err error) {
	interf.ID = req.Id
