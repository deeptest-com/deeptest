...
func (m *InvocationModule) Party() module.WebModule {
	handler := func(index iris.Party) {
		...
		index.Post("/loadInterfaceExecData", m.InvocationCtrl.LoadInterfaceExecData).Name = "获取测试接口"
		index.Post("/submitInterfaceInvokeResult", m.InvocationCtrl.SubmitInterfaceInvokeResult).Name = "提交接口测试结果"
