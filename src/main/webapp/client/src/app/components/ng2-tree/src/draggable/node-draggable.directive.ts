...
export class NodeDraggableDirective implements OnDestroy, OnInit, OnDestroy {
  ...
  private handleDragStart(e: DragEvent): any {
    ...
    this.treeService.fireNodeDragging('start');
    ...
    e.dataTransfer.setDragImage(this.nodeDraggable.nativeElement.querySelector('.value-container'), 10, 10);
  }
  ...
  private handleDrop(e: DragEvent): any {
    ...
    this.treeService.fireNodeDragging('end');
    this.removeClassForInsert();
