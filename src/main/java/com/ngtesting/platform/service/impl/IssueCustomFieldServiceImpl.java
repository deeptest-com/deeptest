...
public class IssueCustomFieldServiceImpl extends BaseServiceImpl implements IssueCustomFieldService {
    ...
    @Override
    public List<IsuCustomField> list(Integer orgId, Integer projectId) {
        List<IsuCustomField> ls = customFieldDao.list(orgId, projectId);
    ...
    public IsuCustomField get(Integer id, Integer orgId) {
        return customFieldDao.get(id, orgId);
    }
