...
public class AiTestTask extends BaseModel {
    ...
    private List<AiTestTask> children = new LinkedList<>();
    ...
    public List<AiTestTask> getChildren() {
        return children;
    }

    public void setChildren(List<AiTestTask> children) {
