...
public class IssueCustomFieldOptionAdmin extends BaseAction {
	@Autowired
	...
	public Map<String, Object> save(HttpServletRequest request, @RequestBody JSONObject json) {
		...
		IsuCustomFieldOption po = customFieldOptionService.save(option, orgId);
		if (po == null) { // 当所属fieldId不是默认org的，结果会返回空
			return authFail();
		}

		List<IsuCustomFieldOption> vos = customFieldOptionService.listVos(fieldId);
