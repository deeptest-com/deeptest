...
type PerformanceTestPlanReqPaginate struct {
	_domain.PaginateReq
...
type PerformanceTestPlanAddInterfacesReq struct {
	InterfaceIds []int `json:"interfaceIds"`
	TargetId     uint  `json:"targetId"`
	CreateBy     uint  `json:"createBy"`
}
type PerformanceTestPlanAddInterfacesFromTreeReq struct {
	SelectedNodes []DiagnoseInterface `json:"selectedNodes"`
	TargetId      uint                `json:"targetId"`
	CreateBy      uint                `json:"createBy"`
}
type PerformanceTestPlanAddCasesFromTreeReq struct {
	SelectedNodes []EndpointCaseTree `json:"selectedNodes"`
	TargetId      uint               `json:"targetId"`
	CreateBy      uint               `json:"createBy"`
}

type PerformanceTestPlanAddPerformanceTestPlanReq struct {
...
type PerformanceTestPlanNodeReq struct {
...
// category
type PerformanceTestPlanCategory struct {
	Id       uint                           `json:"id"`
	Name     string                         `json:"name"`
	Desc     string                         `json:"desc"`
	ParentId uint                           `json:"parentId"`
	Children []*PerformanceTestPlanCategory `json:"children"`
	Slots    iris.Map                       `json:"slots"`
}

type PerformanceTestPlanCategoryCreateReq struct {
	Name      string `json:"name"`
	Mode      string `json:"mode"`
...
type PerformanceTestPlanCategoryReq struct {
	Id     int    `json:"id"`
	Name   string `json:"name"`
	Desc   string `json:"desc"`
	Parent uint
...
type PerformanceTestPlanCategoryMoveReq struct {
	DragKey int                  `json:"dragKey"`
	DropKey int                  `json:"dropKey"`
	DropPos serverConsts.DropPos `json:"dropPos"`
}

type PerformanceTestPlanSimple struct {
	Id        int    `json:"id"`
	Name      string `json:"name"`
	...
	Ordr     int                         `json:"ordr"`
	Children []PerformanceTestPlanSimple `json:"children"`
}

type PerformanceTestPlanPlanReqPaginate struct {
	_domain.PaginateReq
	ProjectId  uint              `json:"projectId"`
	CategoryId int64             `json:"categoryId"`
...
type PerformanceTestPlanCurlImportReq struct {
