...
func (s *DebugInvokeService) GetResult(invokeId int) (results []interface{}, err error) {
	...
	conditions, err := s.ConditionRepo.List(invocation.DebugInterfaceId, invocation.EndpointInterfaceId, consts.ConditionCategoryResult, "", "false", consts.ConditionSrcPost)
...
func (s *DebugInvokeService) GetLog(invokeId int) (results []interface{}, err error) {
	...
	preConditions, err := s.ConditionRepo.List(invocation.DebugInterfaceId, invocation.EndpointInterfaceId, consts.ConditionCategoryConsole, "", "false", consts.ConditionSrcPost)
	...
	postConditions, err := s.ConditionRepo.List(invocation.DebugInterfaceId, invocation.EndpointInterfaceId, consts.ConditionCategoryConsole, "", "false", consts.ConditionSrcPost)
...
func (s *DebugInvokeService) GetAsInterface(id int) (debugData domain.DebugData,
	...
	s.ConditionRepo.ReplaceAll(debugData.DebugInterfaceId, debugData.EndpointInterfaceId, preConditions, debugData.UsedBy)
	s.ConditionRepo.ReplaceAll(debugData.DebugInterfaceId, debugData.EndpointInterfaceId, postConditions, debugData.UsedBy)
