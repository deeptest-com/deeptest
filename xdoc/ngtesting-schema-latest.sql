...
SELECT pg_catalog.setval('public."TstCaseExeStatus_id_seq"', 598, true);
...
SELECT pg_catalog.setval('public."TstCasePriority_id_seq"', 433, true);
...
SELECT pg_catalog.setval('public."TstCaseType_id_seq"', 1011, true);
