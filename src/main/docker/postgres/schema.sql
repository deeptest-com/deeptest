...
DROP FUNCTION public.remove_case_and_its_children(p_case_id integer, p_project_id integer);
...
REVOKE ALL ON SCHEMA public FROM aaron;
...
SELECT pg_catalog.setval('public."TstCaseExeStatus_id_seq"', 602, true);
...
SELECT pg_catalog.setval('public."TstCasePriority_id_seq"', 436, true);
...
SELECT pg_catalog.setval('public."TstCaseType_id_seq"', 1018, true);
