...
public interface AlertDao {
    List<TstAlert> query(@Param("userId") Integer userId,
                         @Param("isRead") Boolean isRead);

    List<TstAlert> scanAlerts(@Param("userId") Integer userId,
                              @Param("startTimeOfToday") Date startTimeOfToday,
    ...
    void removeOldIfNeeded(@Param("taskId") Integer taskId,
                           @Param("assignees") List<TstUser> assignees);
}
