...
func (r *ConditionRepo) List(debugInterfaceId, endpointInterfaceId uint, category consts.ConditionCategory,
	...
	if category == consts.ConditionCategoryAssert {
		db.Where("entity_type = ?", consts.ConditionTypeCheckpoint)
	} else if category == consts.ConditionCategoryConsole {
	...
	} else if category == consts.ConditionCategoryResponse {
		db.Where("entity_type = ?", consts.ConditionTypeResponseDefine)
	} else if category == consts.ConditionCategoryResult {
...
func (r *ConditionRepo) ListExtractor(debugInterfaceId, endpointInterfaceId uint) (pos []model.DebugCondition, err error) {
	db := r.DB.
		Where("NOT deleted").
		Order("ordr ASC")
...
func (r *ConditionRepo) CloneAll(srcDebugInterfaceId, srcEndpointInterfaceId, distDebugInterfaceId uint, dictUsedBy, srcUsedBy consts.UsedBy, forAlternativeCase bool, src consts.ConditionSrc) (err error) {
	srcConditions, err := r.List(srcDebugInterfaceId, srcEndpointInterfaceId, consts.ConditionCategoryAll, srcUsedBy, fmt.Sprintf("%t", forAlternativeCase), src)
...
func (r *ConditionRepo) ReplaceAll(debugInterfaceId, endpointInterfaceId uint,
...
func (r *ConditionRepo) ListTo(debugInterfaceId, endpointInterfaceId uint, usedBy consts.UsedBy, src consts.ConditionSrc) (ret []domain.InterfaceExecCondition, err error) {
	pos, err := r.List(debugInterfaceId, endpointInterfaceId, consts.ConditionCategoryAll, usedBy, "false", consts.ConditionSrcPost)
...
func (r *ConditionRepo) removeAll(debugInterfaceId, endpointInterfaceId uint, usedBy consts.UsedBy) (err error) {
	pos, _ := r.List(debugInterfaceId, endpointInterfaceId, "", usedBy, "false", consts.ConditionSrcPost)
...
func (r *ConditionRepo) RemoveAllForBenchmarkCase(debugInterfaceId, endpointInterfaceId uint, usedBy consts.UsedBy, entityType consts.ConditionCategory) (err error) {
	pos, _ := r.List(debugInterfaceId, endpointInterfaceId, entityType, usedBy, "true", consts.ConditionSrcPost)
...
func (r *ConditionRepo) saveDefault(debugInterfaceId, endpointInterfaceId uint, codes []string, by consts.UsedBy) (po model.DebugCondition, err error) {
