...
const StoreModel: ModuleType = {
    ...
    actions: {
        ...
        async listExtractor({commit, dispatch, state}) {
            try {
                const resp = await listExtractor(state.interfaceData.id, UsedBy.InterfaceDebug);
                const {data} = resp;
        ...
        async listValidExtractorVariableForInterface({commit, dispatch, state}) {
            try {
                ...
                const resp = await listValidExtractorVariableForInterface(state.interfaceData.id, UsedBy.InterfaceDebug);
                const {data} = resp;
        ...
        async listCheckpoint({commit, state}) {
            try {
                const resp = await listCheckpoint(state.interfaceData.id, UsedBy.InterfaceDebug);
                const {data} = resp;
