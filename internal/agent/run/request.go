...
func newRequestBuilder(conf *TConfig, stepRequest *Request) *requestBuilder {
...
func prepareUpload(parser *Parser, step *TStage, stepVariables map[string]interface{}) (err error) {
...
func runStepRequest(r *SessionRunner, step *TStage) (stepResult *StageResult, err error) {
	stepResult = &StageResult{
		Name:          step.Name,
		StageCategory: consts.ProcessorInterface,
		StageType:     consts.ProcessorInterfaceDefault,
		Success:       false,
		ContentSize:   0,
	}
	...
	rb := newRequestBuilder(config, step.Request)
	...
	if r.HTTPStatOn() {
		ctx := WithHTTPStat(rb.req, &httpStat)
...
func (s *StepRequestWithOptionalArgs) Struct() *TStage {
	return s.step
}

func (s *StepRequestWithOptionalArgs) Run(r *SessionRunner) (*StageResult, error) {
...
func (s *StepRequestExtraction) Struct() *TStage {
	return s.step
}

func (s *StepRequestExtraction) Run(r *SessionRunner) (*StageResult, error) {
	if s.step.Request != nil {
		return runStepRequest(r, s.step)
	}
...
func (s *StepRequestValidation) Struct() *TStage {
	return s.step
}

func (s *StepRequestValidation) Run(r *SessionRunner) (*StageResult, error) {
	if s.step.Request != nil {
		return runStepRequest(r, s.step)
	}
	return nil, errors.New("unexpected protocol type")
